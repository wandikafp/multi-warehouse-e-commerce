...
import com.anw.product.service.domain.ports.output.message.publisher.ProductCreatedTestRequestMessagePublisher;
...
public class ProductCommandHandler {
    ...
    private final ProductCreatedTestRequestMessagePublisher productCreatedTestRequestMessagePublisher;
    ...
    public CreateProductResponse createProduct(CreateProductCommand createProductCommand) {
        ...
        productCreatedTestRequestMessagePublisher.publish(productCreatedEvent);
